#pragma checksum "C:\Users\2246072\source\repos\Lab SQL\Lab SQL\Affichage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "A20A291CA43077C7CDA36E06A5C48E3F8BE12200030D40AE8D29DD96A9976D4D"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lab_SQL
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
        ...
        private class Affichage_obj4_Bindings :
            ...
            IAffichage_Bindings
        {
            private global::Lab_SQL.Materiel dataRoot;
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    ...
                    case 9: // Affichage.xaml line 36
                        ...
                        break;
                    case 10: // Affichage.xaml line 37
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_(global::WinRT.CastExtensions.As<global::Lab_SQL.Materiel>(item), 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = global::WinRT.CastExtensions.As<global::Lab_SQL.Materiel>(newDataRoot);
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::Lab_SQL.Materiel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_strCode(obj.strCode, phase);
                        this.Update_strModele(obj.strModele, phase);
                        this.Update_strMeuble(obj.strMeuble, phase);
                        this.Update_strCategorie(obj.strCategorie, phase);
                        this.Update_strCouleur(obj.strCouleur, phase);
                        this.Update_strPrix(obj.strPrix, phase);
                    }
                }
            }
            private void Update_strCode(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Affichage.xaml line 32
            ...
            private void Update_strModele(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_strMeuble(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_strCategorie(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_strCouleur(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_strPrix(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Affichage.xaml line 37
